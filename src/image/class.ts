...
export class Image {
   ...
   */
  clone(): Image {
    return new Image(processing.clone(this.img));
  }
   ...
   * ```
   */
  erode2dilate(pixels: number = 1): Image {
    this.img = processing.erode2dilate(this.img, pixels);
    this.sync();
    return this;
  }
   ...
   * ```
   */
  dilate2erode(pixels: number = 1): Image {
    this.img = processing.dilate2erode(this.img, pixels);
    this.sync();
    return this;
  }
   ...
   */
  invert(): Image {
    this.img = processing.invert(this.img);
    this.sync();
    return this;
  }
   ...
   */
  sepia(): Image {
    this.img = processing.sepia(this.img);
    this.sync();
    return this;
  }
  ...
  hue(degrees: number): Image {
    this.img = processing.hue(this.img, degrees);
    this.sync();
    return this;
  }
  ...
  saturate(factor: number): Image {
    this.img = processing.saturate(this.img, factor);
    this.sync();
    return this;
  }
  ...
  rotate(degrees: number): Image {
    this.img = processing.rotate(this.img, degrees);
    this.sync();
    return this;
  }
   ...
   * ```
   */
  flip(horizontal: boolean = false, vertical: boolean = false): Image {
    this.img = processing.flip(this.img, horizontal, vertical);
    this.sync();
    return this;
  }
  ...
  crop(x: number, y: number, w: number, h: number): Image {
    this.img = processing.crop(this.img, x, y, w, h);
    this.sync();
    return this;
  }
  ...
  resize(
    ...
    this.img = processing.resize(this.img, newWidth, newHeight, algorithm);
    this.sync();
    return this;
  }
   ...
   * ```
   */
  threshold(value: number = 128): Image {
    this.img = processing.threshold(this.img, value);
    this.sync();
    return this;
  }
   ...
   * ```
   */
  adaptiveThreshold(blockSize: number = 11): Image {
    this.img = processing.adaptiveThreshold(this.img, blockSize);
    this.sync();
    return this;
  }
   ...
   * ```
   */
  medianFilter(radius: number = 1): Image {
    this.img = processing.medianFilter(this.img, radius);
    this.sync();
    return this;
  }
   ...
   * ```
   */
  bilateralFilter(spatialSigma: number = 3, rangeSigma: number = 50): Image {
    this.img = processing.bilateralFilter(this.img, spatialSigma, rangeSigma);
    this.sync();
    return this;
  }
  ...
  histogram(): { r: number[]; g: number[]; b: number[] } {
    return processing.histogram(this.img);
  }
   ...
   */
  autoLevel(): Image {
    this.img = processing.autoLevel(this.img);
    this.sync();
    return this;
  }
  ...
  overlay(
    ...
    this.img = processing.overlay(this.img, overlayImg, x, y, alpha);
    this.sync();
    return this;
  }
  ...
  blend(
    ...
    this.img = processing.blend(this.img, img2, mode);
    this.sync();
    return this;
  }
}
